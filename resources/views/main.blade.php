     ...
     <div class="content">
         ...
         <div class="header" id="header">
             <div class="content-inner">
                 <div class="row">
                     <div class="col-md-12">
                         <input type="text" id="poster" value="{{ $hero->image ?? 'Michael Miller' }}" readonly hidden>
                         <p>I'm</p>
                         <h1>{{ $hero->name ?? 'Michael Miller' }}</h1>
                         <h2></h2>
                         <div class="typed-text">
                             {{ $hero->skills ?? 'Web Designer, Web Developer, Front End Developer, Apps Developer, Graphic Designer' }}
                         </div>
                     </div>
                     {{-- <div class="col-md-6 mx-auto">
                         <img class="w-100"
                             src="{{ !empty($hero->image) ? asset('public/storage/hero_poster/' . $hero->image) : '' }}">
                     </div> --}}
                 </div>
         ...
         <div class="large-btn">
             <div class="content-inner">
                 <a class="btn" href="{{ !empty($hero->doc) ? asset('public/storage/hero_doc/' . $hero->doc) : '#' }}"><i
             ...
             <div class="content-inner">
                 ...
                 <div class="row align-items-center">
                     <div class="col-md-6 col-lg-5">
                         ...
                         <img src="{{ !empty($about->image) ? asset('public/storage/about/' . $about->image) : asset('public/user/img/about.jpg') }}"
                             alt="Image" style="width: 300px;height:300px">
                     </div>
                     <div class="col-md-6 col-lg-7 description">
                         <p>{{ !empty($about->description)
                             ? $about->description
                             ...
                             <div class="col-md-6">
                                 <div class="skills">
                                     <div class="skill-name">
                                         ...
                                         <p>{{ $skills->skills_percentage }}%</p>
                                     </div>
                                     <div class="progress">
                                         <div class="progress-bar" role="progressbar"
                                             aria-valuenow="{{ $skills->skills_percentage }}" aria-valuemin="0"
                                 ...
                                 <div class="edu-col">
                                     <div class="row">
                                         <div class="col-6">
                                             ...
                                             <span>Pass Out Year - {{ $educations->education_pass_out_year }}</span>

                                             <h3>{{ $educations->education_degree_name }}</h3>
                                         </div>
                                         <div class="col-6">
                                             @if (!empty($educations->education_result_image))
                                                 <a href="{{ asset('public/storage/education/' . $educations->education_result_image) }}"
                                                     class="btn btn-success float-right" target="_blanck">View Result</a>
                                             @endif
                                         </div>
                                     </div>
                 ...
                 <div class="content-inner">
                     ...
                     <div class="row align-items-center">
                         @foreach ($experience as $experiences)
                             <div class="col-md-12">
                                 <div class="exp-col">
                                     <span>{{ $experiences->joining_date }}
                                         <i>to</i>
                                         {{ $experiences->leaving_date != null ? $experiences->leaving_date : 'till date' }}</span>
                                     <h3>{{ $experiences->company_name }}</h3>
                                     <h4>{{ $experiences->company_address }}</h4>
                                     <h5>{{ $experiences->role }}</h5>
                                     <p>{{ $experiences->description != null ? $experiences->description : '' }}
                                     </p>
                                 </div>
                             </div>
                         @endforeach
                 ...
                 <div class="row portfolio-container">
                     <div class="col-lg-4 col-md-6 portfolio-item web-des">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-1.jpg') }}" class="img-fluid"
                                     alt="">
                     ...
                     <div class="col-lg-4 col-md-6 portfolio-item web-des">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-2.jpg') }}" class="img-fluid"
                                     alt="">
                     ...
                     <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-3.jpg') }}" class="img-fluid"
                                     alt="">
                     ...
                     <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-4.jpg') }}" class="img-fluid"
                                     alt="">
                     ...
                     <div class="col-lg-4 col-md-6 portfolio-item dig-mar">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-5.jpg') }}" class="img-fluid"
                                     alt="">
                     ...
                     <div class="col-lg-4 col-md-6 portfolio-item dig-mar">
                         <div class="portfolio-wrap">
                             <figure>
                                 <img src="{{ asset('public/user/img/portfolio-6.jpg') }}" class="img-fluid"
                                     alt="">
                 ...
                 <div class="row align-items-center review-slider">
                     <div class="col-md-12">
                         <div class="review-slider-item">
                             ...
                             <div class="review-img">
                                 <img src="{{ asset('public/user/img/review-1.jpg') }}" alt="Image">
                     ...
                     <div class="col-md-12">
                         <div class="review-slider-item">
                             ...
                             <div class="review-img">
                                 <img src="{{ asset('public/user/img/review-2.jpg') }}" alt="Image">
                                 <div class="review-name">
                                     <h3>Client Name</h3>
                                     <p>Profession</p>
                                 </div>
                     ...
                     <div class="col-md-12">
                         <div class="review-slider-item">
                             ...
                             <div class="review-img">
                                 <img src="{{ asset('public/user/img/review-3.jpg') }}" alt="Image">
                                 <div class="review-name">
                                     <h3>Client Name</h3>
                                     <p>Profession</p>
                                 </div>
