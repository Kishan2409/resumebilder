                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="leaving_date" name="leaving_date"
                                    value="{{ $data->leaving_date }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter company name"
                                    id="company_name" name="company_name" value="{{ $data->company_name }}" disabled>
                            </div>
                            <div class="col-md-6">
                                <label for="role">Role <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter your role" id="role"
                                    name="role" value="{{ $data->role }}" disabled>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                ...
                                <textarea type="text" class="form-control" placeholder="Enter company address" id="company_address"
                                    name="company_address" disabled>{{ $data->company_address }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="company_description">Company Description </label>
                                <textarea type="text" class="form-control" placeholder="Enter description about company" id="company_description"
                                    name="company_description" disabled>{{ $data->description }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
